...
RUN apt-get -q update \
 && apt-get -qy --no-install-recommends install libtcmalloc-minimal4 libqt5core5a libboost-system1.65.1 libboost-thread1.65.1 libtcl8.5 libjpeg-turbo8 libfreetype6 libssl1.1 libssh2-1 libboost-filesystem1.65.1 libboost-regex1.65.1 libboost-iostreams1.65.1 libcgroup1 libqt5network5 libboost-locale1.65.1 libsqlite3-0 libmpfr6 libexpat1 libxml2 libqt5sql5 openjdk-8-jre-headless odbc-postgresql dh-python libpython3-dev libpython3-stdlib libpython3.6 libpython3.6-minimal libpython3.6-stdlib python3 python3-lib2to3 python3-minimal python3.6 python3.6-minimal \
